...
var base_dir = sdk.io.BaseDir.working_dir;
...
fn findBaseDir() void {
    const dll_module = sdk.os.Module.getLocal(module_name) catch |err| {
        ...
        base_dir = sdk.io.BaseDir.working_dir;
        return;
    };
    base_dir = sdk.io.BaseDir.fromModule(&dll_module) catch |err| {
...
fn performMemorySearch(allocator: std.mem.Allocator, dir: *const sdk.io.BaseDir) dll.game.Memory {
