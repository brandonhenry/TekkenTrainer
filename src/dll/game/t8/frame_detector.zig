...
pub const FrameDetector = struct {
    ...
    pub fn detect(
        self: *Self,
        player_1: *const sdk.misc.Partial(t8.Player),
        player_2: *const sdk.misc.Partial(t8.Player),
    ) bool {
...
test "should detect frames only when frame values are changing or every frame value is null" {
    ...
    try testing.expectEqual(false, detect(null, null, null, null, null, null));
    try testing.expectEqual(false, detect(null, null, null, null, null, null));
    try testing.expectEqual(true, detect(null, null, null, null, 1, 2));
    try testing.expectEqual(true, detect(null, null, null, null, 1, 2));
    try testing.expectEqual(true, detect(1, null, null, null, null, null));
    try testing.expectEqual(false, detect(1, null, null, null, null, null));
    try testing.expectEqual(true, detect(2, null, null, null, null, null));
    try testing.expectEqual(false, detect(2, null, null, null, null, null));
    try testing.expectEqual(true, detect(2, 1, null, null, null, null));
    try testing.expectEqual(false, detect(2, 1, null, null, null, null));
    try testing.expectEqual(true, detect(2, 2, null, null, null, null));
    try testing.expectEqual(false, detect(2, 2, null, null, null, null));
    try testing.expectEqual(true, detect(2, 2, 1, null, null, null));
    try testing.expectEqual(false, detect(2, 2, 1, null, null, null));
    try testing.expectEqual(true, detect(2, 2, 2, null, null, null));
    try testing.expectEqual(false, detect(2, 2, 2, null, null, null));
    try testing.expectEqual(true, detect(2, 2, 2, 1, null, null));
    try testing.expectEqual(false, detect(2, 2, 2, 1, null, null));
    try testing.expectEqual(true, detect(2, 2, 2, 2, null, null));
    try testing.expectEqual(false, detect(2, 2, 2, 2, null, null));
}
